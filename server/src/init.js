...
const P3D_CONFIG_ALL_DIR = path.join(__dirname, '..', 'CuraEngine', 'config', 'config');
...
export {CURA_ENGINE_PATH, STATIC_DIR, CACHE_DIR, P3D_CONFIG_ALL_DIR, P3D_CONFIG_MATERIAL_DIR};
