...
// p3d material
export const P3D_CONFIG_MATERIAL_FETCH = 'P3D_CONFIG_MATERIAL_FETCH';
export const P3D_CONFIG_MATERIAL_UPDATE = 'P3D_CONFIG_MATERIAL_UPDATE';
export const P3D_CONFIG_MATERIAL_DELETE = 'P3D_CONFIG_MATERIAL_DELETE';
export const P3D_CONFIG_MATERIAL_CLONE = 'P3D_CONFIG_MATERIAL_CLONE';

// p3d setting
export const P3D_CONFIG_OTHERS_FETCH = 'P3D_CONFIG_OTHERS_FETCH';
export const P3D_CONFIG_OTHERS_UPDATE = 'P3D_CONFIG_OTHERS_UPDATE';
export const P3D_CONFIG_OTHERS_DELETE = 'P3D_CONFIG_OTHERS_DELETE';
export const P3D_CONFIG_OTHERS_CLONE = 'P3D_CONFIG_OTHERS_CLONE';
