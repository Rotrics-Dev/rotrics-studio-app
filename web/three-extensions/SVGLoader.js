//base：https://github.com/mrdoob/three.js/edit/master/examples/jsm/loaders/SVGLoader.js
//新增功能：获取svg的width，height
import {
    BufferGeometry,
    FileLoader,
...
SVGLoader.prototype = Object.assign( Object.create( Loader.prototype ), {
    ...
    parse: function ( text ) {
        ...
        */
        ...
        //add by liuming
        let width = xml.documentElement.width.baseVal.value;
        let height = xml.documentElement.height.baseVal.value;

        var data = { width, height, paths: paths, xml: xml.documentElement };
